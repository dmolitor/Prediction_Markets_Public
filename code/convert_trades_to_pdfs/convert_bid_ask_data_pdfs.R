...
read_bid_ask <- function(input_file, filter_large_spreads = T) {
  ...
  if(filter_large_spreads == TRUE) {
    ...
    df <- df %>% mutate(large_spread = abs(yes_bid_close - yes_ask_close) > 10)
...
#'
#' @param df A data frame with columns: date, contract_preamble, strike, yes_price.
...
extract_distributions(input_file = 'data/orderbook_data/daily_bid_ask_fed_decisions_data.csv',
                      output_distributions = 'data/daily_bid_ask_distribution_data/middle_out/daily_distributions_fed_levels.csv',
                      output_moments = 'data/daily_bid_ask_moments_data/middle_out/daily_moments_fed_levels.csv',
                      strike_int = 0.25,
                      days_before_horizon = 180)

extract_distributions(input_file = 'data/orderbook_data/daily_bid_ask_cpi_data.csv',
                      output_distributions = 'data/daily_bid_ask_distribution_data/middle_out/daily_distributions_headline_cpi_releases.csv',
                      output_moments = 'data/daily_bid_ask_moments_data/middle_out/daily_moments_headline_cpi_releases.csv',
                      strike_int = 0.1,
                      days_before_horizon = 30)

extract_distributions(input_file = 'data/orderbook_data/daily_bid_ask_unemployment_data.csv',
                      output_distributions = 'data/daily_bid_ask_distribution_data/middle_out/daily_distributions_unemployment_releases.csv',
                      output_moments = 'data/daily_bid_ask_moments_data/middle_out/daily_moments_unemployment_releases.csv',
                      strike_int = 0.1,
                      days_before_horizon = 30)
